...
def create_market_maker(
    ...
    return AvellanedaMarketMaker(
        ...
        adverse_selection_buffer=mm_config.get("adverse_selection_buffer", 0.0),
        ...
        sigma_spike_threshold=mm_config.get("sigma_spike_threshold", 0.0),
        sigma_spike_widening_factor=mm_config.get("sigma_spike_widening_factor", 0.0),
